...
<div class="settings-options">
	...
	<form id="form-video-tiles-settings">
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td><span class="mg-bold mg-heading"><?php _e('GALLERY STYLES', 'maxgalleria') ?></span></td><td></td>
			</tr>
			<tr>
			...
			<tr>
				<td><span class="mg-bold  mg-heading"><?php _e('THUMBNAIL OPTIONS', 'maxgalleria') ?></span></td><td></td>
			</tr>
			<tr>
      ...
      <tr>
			...
			<tr>
				<td><span class="mg-bold  mg-heading"><?php _e('LIGHTBOX SETTINGS', 'maxgalleria') ?></span></td><td></td>
			</tr>
      <tr>
